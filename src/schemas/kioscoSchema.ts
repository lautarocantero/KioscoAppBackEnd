...
📌 El plan de suscripción (KioscoPlanEnum) vive en Auth (ver
   typings/auth), no acá: un usuario paga un único plan que aplica a todos
   los kioscos donde participa (ver services/planService.ts).
──────────────────────────────*/
